...
class ConstitutionalAI:
    ...
    def __init__(self, laws_db_path: str):
        ...
        # Committed facts (0≠1 enforcement across time)
    ...
    def check_admissibility(self, input_state: Dict[str, Any]) -> Tuple[Viability, str]:
        ...
        if self.recursion_depth >= self.max_recursion:
            return (Viability.COLLAPSE, f"Recursion depth {self.recursion_depth} ≥ {self.max_recursion}: Force collapse")
